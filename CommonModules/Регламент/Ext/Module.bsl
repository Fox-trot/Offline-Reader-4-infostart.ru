...
Функция ЭтоФайловыйВариант() Экспорт
	Возврат (СтрНайти(НРег(СтрЗаменить(СтрокаСоединенияИнформационнойБазы(), " ", "")), "file=") >0);
КонецФункции

Функция ЗагружатьRSSПриСтарте() Экспорт
	Возврат Константы.ЗагружатьRSSПриСтарте.Получить() И ЭтоФайловыйВариант();
КонецФункции

Функция ФорматироватьТекст() Экспорт
	Возврат Константы.ФорматироватьТекст.Получить();
КонецФункции
